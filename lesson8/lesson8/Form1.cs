...
namespace lesson8
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //(2+5)/2
            //first read the values, then convert to numerical, produce average
            ...
            //first add the values, than divide by 2, and save to average values
            decimal average = (firstValue + secondValue) / 2;
            //:C has the effect of formatting value as currency
            label1.Text = $"avrage Sallary is {average:C}";
        }
    }
}
